...
def build_model():
    ...
    TemporalAttention1 = Conv1D(1, 1, strides=1)(Anglefullout1) # Temporal Attention Module for each body segment will starts with 1 X 1 Conv
    ...
    AngleAttout1 = Lambda(lambda x: sum(x, axis=1, keepdims=True))(AngleAttout1) # and end with weighted sum-up.
    ...
    # Feature Concat for Classification
...
if __name__ == '__main__':
    ...
    for index in range(len(list)):
        ...
        _, samplenum1, dim1 = y_train.shape # Starting from a specific version of Keras,
